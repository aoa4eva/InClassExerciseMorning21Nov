***Create a controller and include the code below***

Find and remove the code that is not performing a function, and rename the
working routes to reflect what the application is actually doing if necessary.
